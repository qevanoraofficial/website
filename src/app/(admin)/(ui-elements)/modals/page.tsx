...
export const metadata: Metadata = {
  title: "Next.js Modals | QEVANORA OFFICIAL - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for QEVANORA OFFICIAL - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
